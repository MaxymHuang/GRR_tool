"""
Data Parser Module for Gage R&R Analysis (standalone app fork)
...
This file is a fork of the repository root ``data_parser.py``; keep both in sync when changing behavior.
"""
